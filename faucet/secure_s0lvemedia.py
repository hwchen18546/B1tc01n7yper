...
class S0LVEMEDIA():
    def get_captcha_info(self, k):
        url = 'https://api-secure.s0lvemedia.com/papi/challenge.script?'
        url += 'k=' + k
    ...
    def get_captcha_image(mwin, ACPuzzleInfo_ckey, ACPuzzleInfo_magic, ACPuzzleInfo_stamp, name):
        while 1:
            url = 'https://api-secure.s0lvemedia.com/papi/_challenge.js?'
            ...
            url = 'https://api-secure.s0lvemedia.com/papi/media?'
